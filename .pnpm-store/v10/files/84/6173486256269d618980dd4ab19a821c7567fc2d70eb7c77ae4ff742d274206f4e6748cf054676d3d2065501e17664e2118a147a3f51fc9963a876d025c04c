...
import { modalTitle, route, closeEvent, routerHistory } from '../../state/mod.js';
import { computed } from "@preact/signals";
import { SwkAppRoute } from "../../types/mod.js";
import { Button, ButtonMode, ButtonShape, ButtonSize } from './button.js';
...
const leftButtonComponent = computed(() => {
