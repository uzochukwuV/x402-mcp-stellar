...
export type TextType = 'h1-regular-mono' | 'h1-regular' | 'h1-medium' | 'h2-regular-mono' | 'h2-regular' | 'h2-medium' | 'h3-regular-mono' | 'h3-regular' | 'h3-medium' | 'h4-regular-mono' | 'h4-regular' | 'h4-medium' | 'h5-regular-mono' | 'h5-regular' | 'h5-medium' | 'h6-regular-mono' | 'h6-regular' | 'h6-medium' | 'lg-regular-mono' | 'lg-regular' | 'lg-medium' | 'md-regular-mono' | 'md-regular' | 'md-medium' | 'sm-regular-mono' | 'sm-regular' | 'sm-medium';
...
export type ButtonVariant = 'accent-primary' | 'accent-secondary' | 'neutral-primary' | 'neutral-secondary' | 'error-primary' | 'error-secondary' | 'neutral-tertiary';
...
export type TransactionIconType = 'arrowBottom' | 'arrowTop' | 'swapVertical' | 'swapHorizontal' | 'checkmark' | 'close';
