...
exports.SwkAppDarkTheme = exports.SwkAppLightTheme = exports.SwkAppMode = exports.SwkAppRoute = void 0;
var SwkAppRoute;
(function (SwkAppRoute) {
...
})(SwkAppRoute || (exports.SwkAppRoute = SwkAppRoute = {}));
var SwkAppMode;
(function (SwkAppMode) {
    SwkAppMode["FIXED"] = "FIXED";
    SwkAppMode["BLOCK"] = "BLOCK";
    SwkAppMode["HIDDEN"] = "HIDDEN";
})(SwkAppMode || (exports.SwkAppMode = SwkAppMode = {}));
exports.SwkAppLightTheme = {
    "background": "#fcfcfcff",
