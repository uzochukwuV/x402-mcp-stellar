...
exports.reset = exports.keyframes = exports.injectGlobal = exports.tx = exports.tw = exports.cx = void 0;
const core_1 = require("@twind/core");
var core_2 = require("@twind/core");
Object.defineProperty(exports, "cx", { enumerable: true, get: function () { return core_2.cx; } });
...
const config = (0, core_1.defineConfig)({
    ...
    presets: [(0, preset_autoprefix_1.default)(), (0, base_1.default)({ disablePreflight: true })],
});
// @ts-expect-error - We don't care about the current error
const _tw = (0, core_1.twind)(config, typeof document === "undefined" ? (0, core_1.virtual)() : (0, core_1.cssom)("style[data-library]"));
const tw = (text) => _tw(`!(${text})`);
exports.tw = tw;
exports.tx = core_1.tx.bind(_tw);
exports.injectGlobal = core_1.injectGlobal.bind(_tw);
exports.keyframes = core_1.keyframes.bind(_tw);
exports.reset = (0, core_1.css) `
  .stellar-wallets-kit *,
