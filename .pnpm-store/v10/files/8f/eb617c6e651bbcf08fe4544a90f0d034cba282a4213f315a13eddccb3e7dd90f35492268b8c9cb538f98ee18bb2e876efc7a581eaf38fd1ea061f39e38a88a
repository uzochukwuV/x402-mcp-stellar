...
export declare const SolAppPleaseEnableContractData: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const CeloAppPleaseEnableContractData: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const InvalidTransactionError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const UnsupportedFeatureError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const NanoSNotSupported: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
...
export declare const ConcordiumInsufficientFunds: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const ConcordiumMemoTooLong: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const ConcordiumPairingExpiredError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
export declare const ConcordiumSessionExpiredError: LedgerErrorConstructor<{
    [key: string]: unknown;
}>;
