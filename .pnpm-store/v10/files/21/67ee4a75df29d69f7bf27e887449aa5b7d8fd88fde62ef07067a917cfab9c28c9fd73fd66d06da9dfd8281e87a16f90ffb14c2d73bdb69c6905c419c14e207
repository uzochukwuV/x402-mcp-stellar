...
import { activeAddress, activeModule, modalTitle } from '../../state/values.js';
import { Button, ButtonMode, ButtonSize } from '../shared/button.js';
import { Avatar, AvatarSize } from '../shared/avatar.js';
import { signal } from "@preact/signals";
import { disconnect } from '../../sdk/utils.js';
const showCopiedText = signal(false);
