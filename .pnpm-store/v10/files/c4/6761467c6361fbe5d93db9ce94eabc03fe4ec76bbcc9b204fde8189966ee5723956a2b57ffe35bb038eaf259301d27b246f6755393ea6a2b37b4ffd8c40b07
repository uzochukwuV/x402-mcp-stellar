...
export declare abstract class AppKitBaseClient {
    ...
    getPreferredAccountType: (namespace: ChainNamespace) => "payment" | "eoa" | "ordinal" | "stx" | "smartAccount" | undefined;
    ...
    getAccount(_namespace?: ChainNamespace): {
        ...
        embeddedWalletInfo: {
            ...
            accountType: "payment" | "eoa" | "ordinal" | "stx" | "smartAccount" | undefined;
