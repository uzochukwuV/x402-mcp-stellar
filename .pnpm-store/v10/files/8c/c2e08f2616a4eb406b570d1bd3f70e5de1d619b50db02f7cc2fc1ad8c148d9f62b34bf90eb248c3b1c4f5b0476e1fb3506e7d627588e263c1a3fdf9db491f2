...
export declare const ViemUtil: {
    ...
    getViemChain(caipNetwork: CaipNetwork): Promise<{
        ...
        readonly caipNetworkId: `eip155:${string}` | `eip155:${number}` | `solana:${string}` | `solana:${number}` | `polkadot:${string}` | `polkadot:${number}` | `bip122:${string}` | `bip122:${number}` | `cosmos:${string}` | `cosmos:${number}` | `sui:${string}` | `sui:${number}` | `stacks:${string}` | `stacks:${number}` | `ton:${string}` | `ton:${number}` | `tron:${string}` | `tron:${number}`;
        readonly assets?: {
